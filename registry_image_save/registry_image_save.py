...
from malware_scan_registry import max_days, MalwareScanECRImages, MalwareScanDockerPrivateRegistryImages, \
    MalwareScanHarborRegistryImages, MalwareScanAzureRegistryImages, REGISTRY_TYPE_DOCKER_PVT, REGISTRY_TYPE_HARBOR, \
    REGISTRY_TYPE_ECR, REGISTRY_TYPE_AZURE, REGISTRY_TYPE_DOCKER_HUB, MalwareScanDockerHubImages, REGISTRY_TYPE_QUAY, \
    MalwareScanQuayRegistryImages, REGISTRY_TYPE_GITLAB, MalwareScanGitlabRegistryImages, REGISTRY_TYPE_GCLOUD, \
    MalwareScanGoogleRegistryImages, REGISTRY_TYPE_JFROG, MalwareScanJfrogRegistryImages
...
def main():
    ...
    if credential_id:
        ...
        if registry_type == REGISTRY_TYPE_ECR:
            try:
                registry_scanner = MalwareScanECRImages(
            ...
            try:
                registry_scanner = MalwareScanHarborRegistryImages(
            ...
            try:
                registry_scanner = MalwareScanDockerHubImages(
            ...
            try:
                registry_scanner = MalwareScanDockerPrivateRegistryImages(
            ...
            try:
                registry_scanner = MalwareScanQuayRegistryImages(
            ...
            try:
                registry_scanner = MalwareScanAzureRegistryImages(
            ...
            try:
                registry_scanner = MalwareScanGitlabRegistryImages(
            ...
            try:
                registry_scanner = MalwareScanGoogleRegistryImages(
            ...
            try:
                registry_scanner = MalwareScanJfrogRegistryImages(
