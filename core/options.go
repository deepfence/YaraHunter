...
func ParseOptions() (*Options, error) {
	options := &Options{
		...
		ConfigPath:      flag.String("config-path", "", "Searches for config.yaml from given directory. If not set, tries to find it from IOCcanner binary's and current directory"),
